...
<div style="height:50%; width:50%; border:2px solid #000000; text-align:center; margin-left:20%; margin-top:3%;">
 <div style="height:60%; width:100%; margin-top:3%;">
  <div style="text-align:center; margin-left:2%; float:left; margin-top:10%; margin-right:12;">	SUBJECT	</div>
  <div style="text-align:center; margin-left:2%; float:right; margin-right:12;">	<input type="text" name="sub" placeholder="Post notice"></textarea>	</div>
 </div>
 <div style="height:60%; width:100%; margin-top:3%;">
