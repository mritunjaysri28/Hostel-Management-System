<?php
 ...
 $pdo=new PDO("mysql:host=$host;dbname=$dbname",$user,$pass);
  ...
  class medback
  {
		...
		{
			    global $pdo;
	            $smt=$pdo->prepare("select * from mdetails order by medicinename");
				if($smt->execute())
				{?>
				   <div style="margin-top:1%;">
					<table width="984" bordercolor="#996600" border="2px">
					  <tr>
					    <th width="86">Sr.No.</th>
						<th width="150">MEDICINE NAME</th>
						<th width="115">MAX STOCK</th>
						<th width="206">AVAILABLE MEDICINE</th>
						<th width="391">USE</th>
				      </tr><?php $srno=0; 
			   		  ...
			   		  {  
			     			...
			     			{?>
								<tr>
								 ...
								 <td align="center"><?php echo $row->medicinename;?></td>
								 <td align="center"><?php echo $row->maxstock;?></td>
								 <td align="center"><?php echo $row->avilablestock;?></td>
								 <td align="center"><?php echo $row->used;?></td>
								</tr><?php  
				  			}	
						}
				}?></table></div><?php
