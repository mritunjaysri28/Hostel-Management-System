<form method="post">
<div style="width:100%; height:9%; margin-top:1%; border:2px solid #000000;">
...
<?php
 ...
 {
?>
 	<div style="height:90%; width:90%; border:2px solid #000000; margin-left:1%; margin-top:1%;">
...
<?php
 ...
 ?>
 	<div style="height:90%; width:90%; border:2px solid #000000; margin-left:1%; margin-top:1%;">
	  <div style="width:100%; float:left;">
	    <div style="width:25%; float:left; margin-top:1%; margin-left:1%;">		MEDICINE NAME	</div>
	    <div style="width:25%; float:left; margin-top:1%; margin-left:1%;">		<input type="text" name="mname" placeholder="Student regiestration" />	</div>
	  </div>
  	  <div style="width:100%; float:left;">
	    <div style="width:25%; float:left; margin-top:1%; margin-left:1%;">		MAX STOCK	</div>
	    <div style="width:25%; float:left; margin-top:1%; margin-left:1%;">		<input type="text" name="medmax" placeholder="" />	</div>
	  </div>	
  	  <div style="width:100%; float:left;">
